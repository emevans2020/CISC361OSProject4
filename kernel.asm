...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 18 78 10 80 	movl   $0x80107818,(%esp)
...
801020f1:	e8 8a 20 00 00       	call   80104180 <wakeup>
...
801021b9:	e8 02 1e 00 00       	call   80103fc0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102bc5:	e8 f6 13 00 00       	call   80103fc0 <sleep>
...
80102d12:	00 00 00 
    wakeup(&log);
80102d15:	e8 66 14 00 00       	call   80104180 <wakeup>
    release(&log.lock);
...
80102d40:	e8 3b 14 00 00       	call   80104180 <wakeup>
  release(&log.lock);
...
8010345d:	e8 5e 0b 00 00       	call   80103fc0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103545:	e8 76 0a 00 00       	call   80103fc0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103641:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->queueNum = 3;
80103648:	c7 43 7c 03 00 00 00 	movl   $0x3,0x7c(%ebx)
  p->remainingIterations = 8;
8010364f:	c7 83 80 00 00 00 08 	movl   $0x8,0x80(%ebx)
80103656:	00 00 00 
  p->iterations = 0;
...
8010366e:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103674:	e8 97 10 00 00       	call   80104710 <release>
...
80103696:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103699:	c7 40 14 61 59 10 80 	movl   $0x80105961,0x14(%eax)
  p->context = (struct context*)sp;
...
801036a8:	e8 b3 10 00 00       	call   80104760 <memset>
...
801036d2:	e8 39 10 00 00       	call   80104710 <release>
}
...
801036fb:	e8 10 10 00 00       	call   80104710 <release>
...
80103750:	e8 bb 0d 00 00       	call   80104510 <initlock>
}
...
801037c0:	68 3c 77 10 80       	push   $0x8010773c
801037c5:	e8 c6 cb ff ff       	call   80100390 <panic>
    panic("mycpu called with interrupts enabled\n");
801037ca:	83 ec 0c             	sub    $0xc,%esp
801037cd:	68 74 78 10 80       	push   $0x80107874
...
80103804:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103807:	e8 74 0d 00 00       	call   80104580 <pushcli>
  c = mycpu();
8010380c:	e8 4f ff ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103811:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103817:	e8 a4 0d 00 00       	call   801045c0 <popcli>
}
...
80103843:	e8 e8 36 00 00       	call   80106f30 <setupkvm>
...
80103861:	e8 aa 33 00 00       	call   80106c10 <inituvm>
...
80103876:	e8 e5 0e 00 00       	call   80104760 <memset>
...
801038cf:	68 65 77 10 80       	push   $0x80107765
801038d4:	50                   	push   %eax
801038d5:	e8 66 10 00 00       	call   80104940 <safestrcpy>
  p->cwd = namei("/");
801038da:	c7 04 24 6e 77 10 80 	movl   $0x8010776e,(%esp)
...
80103913:	68 4c 77 10 80       	push   $0x8010774c
...
80103925:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103928:	e8 53 0c 00 00       	call   80104580 <pushcli>
  c = mycpu();
8010392d:	e8 2e fe ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103932:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103938:	e8 83 0c 00 00       	call   801045c0 <popcli>
  if(n > 0){
...
8010394c:	e8 af 31 00 00       	call   80106b00 <switchuvm>
  return 0;
...
8010396a:	e8 e1 33 00 00       	call   80106d50 <allocuvm>
...
8010398a:	e8 f1 34 00 00       	call   80106e80 <deallocuvm>
...
801039a6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801039a9:	e8 d2 0b 00 00       	call   80104580 <pushcli>
  c = mycpu();
801039ae:	e8 ad fd ff ff       	call   80103760 <mycpu>
  p = c->proc;
801039b3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039b9:	e8 02 0c 00 00       	call   801045c0 <popcli>
  if((np = allocproc()) == 0){
...
801039d8:	e8 23 36 00 00       	call   80107000 <copyuvm>
...
80103a51:	e8 ea 0e 00 00       	call   80104940 <safestrcpy>
  pid = np->pid;
...
80103a73:	e8 98 0c 00 00       	call   80104710 <release>
  return pid;
...
80103ac4:	8b 55 08             	mov    0x8(%ebp),%edx
80103ac7:	8b 4d 0c             	mov    0xc(%ebp),%ecx
	if ((p->queueNum < maxQueue && !(p->queueNum == 0 && maxQueue == 0)) || p->remainingIterations <= 0){
80103aca:	8b 5a 7c             	mov    0x7c(%edx),%ebx
80103acd:	39 cb                	cmp    %ecx,%ebx
80103acf:	7d 06                	jge    80103ad7 <runnable+0x17>
		return 0;
80103ad1:	31 c0                	xor    %eax,%eax
	if ((p->queueNum < maxQueue && !(p->queueNum == 0 && maxQueue == 0)) || p->remainingIterations <= 0){
80103ad3:	09 cb                	or     %ecx,%ebx
80103ad5:	75 0d                	jne    80103ae4 <runnable+0x24>
80103ad7:	8b 92 80 00 00 00    	mov    0x80(%edx),%edx
80103add:	31 c0                	xor    %eax,%eax
80103adf:	85 d2                	test   %edx,%edx
80103ae1:	0f 9f c0             	setg   %al
}
80103ae4:	5b                   	pop    %ebx
80103ae5:	5d                   	pop    %ebp
80103ae6:	c3                   	ret    
...
80103af0 <changeQueue>:
void changeQueue(struct proc *p, int queueNew){
80103af0:	55                   	push   %ebp
80103af1:	89 e5                	mov    %esp,%ebp
80103af3:	8b 45 0c             	mov    0xc(%ebp),%eax
80103af6:	8b 55 08             	mov    0x8(%ebp),%edx
	switch (queueNew){
80103af9:	83 f8 01             	cmp    $0x1,%eax
	p->queueNum = queueNew;
80103afc:	89 42 7c             	mov    %eax,0x7c(%edx)
        p->iterations = 0;
80103aff:	c7 82 84 00 00 00 00 	movl   $0x0,0x84(%edx)
80103b06:	00 00 00 
	switch (queueNew){
80103b09:	74 55                	je     80103b60 <changeQueue+0x70>
80103b0b:	7e 2b                	jle    80103b38 <changeQueue+0x48>
80103b0d:	83 f8 02             	cmp    $0x2,%eax
80103b10:	74 16                	je     80103b28 <changeQueue+0x38>
80103b12:	83 f8 03             	cmp    $0x3,%eax
80103b15:	75 39                	jne    80103b50 <changeQueue+0x60>
		p->remainingIterations = 8;
80103b17:	c7 82 80 00 00 00 08 	movl   $0x8,0x80(%edx)
80103b1e:	00 00 00 
}
80103b21:	5d                   	pop    %ebp
80103b22:	c3                   	ret    
...
80103b24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		p->remainingIterations = 16;
80103b28:	c7 82 80 00 00 00 10 	movl   $0x10,0x80(%edx)
80103b2f:	00 00 00 
}
80103b32:	5d                   	pop    %ebp
80103b33:	c3                   	ret    
...
80103b3a:	75 14                	jne    80103b50 <changeQueue+0x60>
		p->remainingIterations = 500;
80103b3c:	c7 82 80 00 00 00 f4 	movl   $0x1f4,0x80(%edx)
80103b43:	01 00 00 
}
80103b46:	5d                   	pop    %ebp
80103b47:	c3                   	ret    
...
80103b50:	c7 45 08 70 77 10 80 	movl   $0x80107770,0x8(%ebp)
}
80103b57:	5d                   	pop    %ebp
		cprintf ("Not a valid queue level");
80103b58:	e9 03 cb ff ff       	jmp    80100660 <cprintf>
80103b5d:	8d 76 00             	lea    0x0(%esi),%esi
		p->remainingIterations = 24;
80103b60:	c7 82 80 00 00 00 18 	movl   $0x18,0x80(%edx)
80103b67:	00 00 00 
}
80103b6a:	5d                   	pop    %ebp
80103b6b:	c3                   	ret    
...
80103b70 <queueLevelCheck>:
void queueLevelCheck (struct proc *p){
80103b70:	55                   	push   %ebp
80103b71:	89 e5                	mov    %esp,%ebp
80103b73:	83 ec 08             	sub    $0x8,%esp
80103b76:	8b 45 08             	mov    0x8(%ebp),%eax
   if (p->remainingIterations <=0){
80103b79:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80103b7f:	85 d2                	test   %edx,%edx
80103b81:	7e 15                	jle    80103b98 <queueLevelCheck+0x28>
   if (p->iterations > p->remainingIterations){
80103b83:	3b 90 84 00 00 00    	cmp    0x84(%eax),%edx
80103b89:	7d 08                	jge    80103b93 <queueLevelCheck+0x23>
	if (p->queueNum < 3){
80103b8b:	8b 50 7c             	mov    0x7c(%eax),%edx
80103b8e:	83 fa 02             	cmp    $0x2,%edx
80103b91:	7e 25                	jle    80103bb8 <queueLevelCheck+0x48>
}
80103b93:	c9                   	leave  
80103b94:	c3                   	ret    
80103b95:	8d 76 00             	lea    0x0(%esi),%esi
	if (p->queueNum >0){
80103b98:	8b 50 7c             	mov    0x7c(%eax),%edx
80103b9b:	85 d2                	test   %edx,%edx
80103b9d:	7e f4                	jle    80103b93 <queueLevelCheck+0x23>
		changeQueue(p, p->queueNum -1);
80103b9f:	83 ec 08             	sub    $0x8,%esp
80103ba2:	83 ea 01             	sub    $0x1,%edx
80103ba5:	52                   	push   %edx
80103ba6:	50                   	push   %eax
80103ba7:	e8 44 ff ff ff       	call   80103af0 <changeQueue>
...
80103bbb:	83 c2 01             	add    $0x1,%edx
80103bbe:	52                   	push   %edx
80103bbf:	50                   	push   %eax
80103bc0:	e8 2b ff ff ff       	call   80103af0 <changeQueue>
...
80103be5:	00 00 00 
  struct cpu *c = mycpu();
80103be8:	89 45 e0             	mov    %eax,-0x20(%ebp)
80103beb:	83 c0 04             	add    $0x4,%eax
80103bee:	89 45 dc             	mov    %eax,-0x24(%ebp)
80103bf1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    int maxQueue = ptable.proc->queueNum;
80103bf8:	8b 35 d0 2d 11 80    	mov    0x80112dd0,%esi
  asm volatile("sti");
80103bfe:	fb                   	sti    
    acquire(&ptable.lock);
80103bff:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c02:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
    acquire(&ptable.lock);
80103c07:	68 20 2d 11 80       	push   $0x80112d20
80103c0c:	e8 3f 0a 00 00       	call   80104650 <acquire>
80103c11:	83 c4 10             	add    $0x10,%esp
80103c14:	eb 18                	jmp    80103c2e <scheduler+0x5e>
80103c16:	8d 76 00             	lea    0x0(%esi),%esi
80103c19:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c20:	81 c3 88 00 00 00    	add    $0x88,%ebx
80103c26:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80103c2c:	73 20                	jae    80103c4e <scheduler+0x7e>
	if (p->state == RUNNABLE){
80103c2e:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80103c32:	75 ec                	jne    80103c20 <scheduler+0x50>
	   queueLevelCheck(p);
80103c34:	83 ec 0c             	sub    $0xc,%esp
80103c37:	53                   	push   %ebx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c38:	81 c3 88 00 00 00    	add    $0x88,%ebx
	   queueLevelCheck(p);
80103c3e:	e8 2d ff ff ff       	call   80103b70 <queueLevelCheck>
80103c43:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c46:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80103c4c:	72 e0                	jb     80103c2e <scheduler+0x5e>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c4e:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103c53:	90                   	nop
80103c54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        if (p->state == RUNNABLE && p->queueNum > maxQueue){
80103c58:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103c5c:	75 08                	jne    80103c66 <scheduler+0x96>
80103c5e:	8b 50 7c             	mov    0x7c(%eax),%edx
80103c61:	39 d6                	cmp    %edx,%esi
80103c63:	0f 4c f2             	cmovl  %edx,%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c66:	05 88 00 00 00       	add    $0x88,%eax
80103c6b:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103c70:	72 e6                	jb     80103c58 <scheduler+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c72:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103c77:	89 75 e4             	mov    %esi,-0x1c(%ebp)
80103c7a:	eb 7c                	jmp    80103cf8 <scheduler+0x128>
80103c7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	cprintf("Process [%s:%d] | Queue Number: %d | Idle Count: %d | Remaining Iterations on current queue level: %d0 ms\n", p->name,p->pid, p->queueNum,
80103c80:	83 ec 08             	sub    $0x8,%esp
	   p->remainingIterations--;
...
80103c93:	52                   	push   %edx
80103c94:	57                   	push   %edi
80103c95:	56                   	push   %esi
80103c96:	68 9c 78 10 80       	push   $0x8010789c
	   p->remainingIterations--;
80103c9b:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	cprintf("Process [%s:%d] | Queue Number: %d | Idle Count: %d | Remaining Iterations on current queue level: %d0 ms\n", p->name,p->pid, p->queueNum,
80103ca1:	e8 ba c9 ff ff       	call   80100660 <cprintf>
        cprintf("-------------------------------------------------------------------------------------------------\n");
80103ca6:	83 c4 14             	add    $0x14,%esp
80103ca9:	68 08 79 10 80       	push   $0x80107908
80103cae:	e8 ad c9 ff ff       	call   80100660 <cprintf>
      c->proc = p;
80103cb3:	8b 7d e0             	mov    -0x20(%ebp),%edi
80103cb6:	89 9f ac 00 00 00    	mov    %ebx,0xac(%edi)
      switchuvm(p);
80103cbc:	89 1c 24             	mov    %ebx,(%esp)
80103cbf:	e8 3c 2e 00 00       	call   80106b00 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103cc4:	58                   	pop    %eax
80103cc5:	5a                   	pop    %edx
80103cc6:	ff 73 1c             	pushl  0x1c(%ebx)
80103cc9:	ff 75 dc             	pushl  -0x24(%ebp)
      p->state = RUNNING;
80103ccc:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103cd3:	e8 c3 0c 00 00       	call   8010499b <swtch>
      switchkvm();
80103cd8:	e8 03 2e 00 00       	call   80106ae0 <switchkvm>
      c->proc = 0;
80103cdd:	c7 87 ac 00 00 00 00 	movl   $0x0,0xac(%edi)
80103ce4:	00 00 00 
80103ce7:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cea:	81 c3 88 00 00 00    	add    $0x88,%ebx
80103cf0:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80103cf6:	73 64                	jae    80103d5c <scheduler+0x18c>
        if(p->state != RUNNABLE){
80103cf8:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80103cfc:	75 ec                	jne    80103cea <scheduler+0x11a>
	if ((p->queueNum < maxQueue && !(p->queueNum == 0 && maxQueue == 0)) || p->remainingIterations <= 0){
80103cfe:	8b 53 7c             	mov    0x7c(%ebx),%edx
80103d01:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103d04:	8d 73 6c             	lea    0x6c(%ebx),%esi
80103d07:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
80103d0d:	8b 7b 10             	mov    0x10(%ebx),%edi
80103d10:	39 d1                	cmp    %edx,%ecx
80103d12:	7e 04                	jle    80103d18 <scheduler+0x148>
80103d14:	09 d1                	or     %edx,%ecx
80103d16:	75 08                	jne    80103d20 <scheduler+0x150>
80103d18:	85 c0                	test   %eax,%eax
80103d1a:	0f 8f 60 ff ff ff    	jg     80103c80 <scheduler+0xb0>
	   p->iterations++;
80103d20:	8b 8b 84 00 00 00    	mov    0x84(%ebx),%ecx
	   cprintf("Process [%s:%d] | Queue Number: %d | Idle Count: %d | Remaining Iterations on current queue level: %d0 ms\n", p->name,p->pid, p->queueNum,
80103d26:	83 ec 08             	sub    $0x8,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d29:	81 c3 88 00 00 00    	add    $0x88,%ebx
	   cprintf("Process [%s:%d] | Queue Number: %d | Idle Count: %d | Remaining Iterations on current queue level: %d0 ms\n", p->name,p->pid, p->queueNum,
80103d2f:	50                   	push   %eax
	   p->iterations++;
80103d30:	83 c1 01             	add    $0x1,%ecx
	   cprintf("Process [%s:%d] | Queue Number: %d | Idle Count: %d | Remaining Iterations on current queue level: %d0 ms\n", p->name,p->pid, p->queueNum,
80103d33:	51                   	push   %ecx
80103d34:	52                   	push   %edx
80103d35:	57                   	push   %edi
80103d36:	56                   	push   %esi
80103d37:	68 9c 78 10 80       	push   $0x8010789c
	   p->iterations++;
80103d3c:	89 4b fc             	mov    %ecx,-0x4(%ebx)
	   cprintf("Process [%s:%d] | Queue Number: %d | Idle Count: %d | Remaining Iterations on current queue level: %d0 ms\n", p->name,p->pid, p->queueNum,
80103d3f:	e8 1c c9 ff ff       	call   80100660 <cprintf>
	   cprintf("-------------------------------------------------------------------------------------------------\n");
80103d44:	83 c4 14             	add    $0x14,%esp
80103d47:	68 08 79 10 80       	push   $0x80107908
80103d4c:	e8 0f c9 ff ff       	call   80100660 <cprintf>
	   continue;
80103d51:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d54:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80103d5a:	72 9c                	jb     80103cf8 <scheduler+0x128>
    release(&ptable.lock);
80103d5c:	83 ec 0c             	sub    $0xc,%esp
80103d5f:	68 20 2d 11 80       	push   $0x80112d20
80103d64:	e8 a7 09 00 00       	call   80104710 <release>
  for(;;){
80103d69:	83 c4 10             	add    $0x10,%esp
80103d6c:	e9 87 fe ff ff       	jmp    80103bf8 <scheduler+0x28>
80103d71:	eb 0d                	jmp    80103d80 <sched>
80103d73:	90                   	nop
80103d74:	90                   	nop
80103d75:	90                   	nop
80103d76:	90                   	nop
...
80103dc7:	75 41                	jne    80103e0a <sched+0x8a>
  intena = mycpu()->intena;
80103dc9:	e8 92 f9 ff ff       	call   80103760 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103dce:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103dd1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103dd7:	e8 84 f9 ff ff       	call   80103760 <mycpu>
80103ddc:	83 ec 08             	sub    $0x8,%esp
80103ddf:	ff 70 04             	pushl  0x4(%eax)
80103de2:	53                   	push   %ebx
80103de3:	e8 b3 0b 00 00       	call   8010499b <swtch>
  mycpu()->intena = intena;
80103de8:	e8 73 f9 ff ff       	call   80103760 <mycpu>
}
...
80103e46:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103e49:	e8 32 07 00 00       	call   80104580 <pushcli>
  c = mycpu();
80103e4e:	e8 0d f9 ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103e53:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e59:	e8 62 07 00 00       	call   801045c0 <popcli>
  if(curproc == initproc)
80103e5e:	39 35 b8 a5 10 80    	cmp    %esi,0x8010a5b8
80103e64:	8d 5e 28             	lea    0x28(%esi),%ebx
80103e67:	8d 7e 68             	lea    0x68(%esi),%edi
80103e6a:	0f 84 f1 00 00 00    	je     80103f61 <exit+0x121>
    if(curproc->ofile[fd]){
...
80103ea4:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103eab:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103eb2:	e8 99 07 00 00       	call   80104650 <acquire>
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ebd:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
...
80103edf:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ee6:	05 88 00 00 00       	add    $0x88,%eax
80103eeb:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103ef0:	72 e2                	jb     80103ed4 <exit+0x94>
      p->parent = initproc;
80103ef2:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ef8:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103efd:	eb 0f                	jmp    80103f0e <exit+0xce>
80103eff:	90                   	nop
80103f00:	81 c2 88 00 00 00    	add    $0x88,%edx
80103f06:	81 fa 54 4f 11 80    	cmp    $0x80114f54,%edx
...
80103f28:	05 88 00 00 00       	add    $0x88,%eax
80103f2d:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
80103f7c:	e8 cf 06 00 00       	call   80104650 <acquire>
  pushcli();
80103f81:	e8 fa 05 00 00       	call   80104580 <pushcli>
  c = mycpu();
80103f86:	e8 d5 f7 ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103f8b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f91:	e8 2a 06 00 00       	call   801045c0 <popcli>
...
80103fa9:	e8 62 07 00 00       	call   80104710 <release>
}
...
80103fcc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103fcf:	e8 ac 05 00 00       	call   80104580 <pushcli>
  c = mycpu();
80103fd4:	e8 87 f7 ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103fd9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103fdf:	e8 dc 05 00 00       	call   801045c0 <popcli>
  if(p == 0)
...
80104000:	e8 4b 06 00 00       	call   80104650 <acquire>
    release(lk);
...
8010402a:	e8 e1 06 00 00       	call   80104710 <release>
    acquire(lk);
...
8010403b:	5d                   	pop    %ebp
    acquire(lk);
8010403c:	e9 0f 06 00 00       	jmp    80104650 <acquire>
...
80104069:	68 e7 77 10 80       	push   $0x801077e7
8010406e:	e8 1d c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80104073:	83 ec 0c             	sub    $0xc,%esp
80104076:	68 e1 77 10 80       	push   $0x801077e1
...
80104085:	e8 f6 04 00 00       	call   80104580 <pushcli>
  c = mycpu();
8010408a:	e8 d1 f6 ff ff       	call   80103760 <mycpu>
  p = c->proc;
8010408f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104095:	e8 26 05 00 00       	call   801045c0 <popcli>
  acquire(&ptable.lock);
8010409a:	83 ec 0c             	sub    $0xc,%esp
8010409d:	68 20 2d 11 80       	push   $0x80112d20
801040a2:	e8 a9 05 00 00       	call   80104650 <acquire>
...
801040d7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040dc:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
...
801040f8:	e8 c3 fe ff ff       	call   80103fc0 <sleep>
    havekids = 0;
...
8010410e:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104111:	e8 fa e1 ff ff       	call   80102310 <kfree>
        freevm(p->pgdir);
80104116:	5a                   	pop    %edx
80104117:	ff 73 04             	pushl  0x4(%ebx)
        p->kstack = 0;
8010411a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104121:	e8 8a 2d 00 00       	call   80106eb0 <freevm>
        release(&ptable.lock);
80104126:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
8010412d:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80104134:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
8010413b:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
8010413f:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80104146:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010414d:	e8 be 05 00 00       	call   80104710 <release>
        return pid;
...
80104161:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104166:	68 20 2d 11 80       	push   $0x80112d20
8010416b:	e8 a0 05 00 00       	call   80104710 <release>
      return -1;
...
8010418f:	e8 bc 04 00 00       	call   80104650 <acquire>
...
801041aa:	73 1e                	jae    801041ca <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
...
801041c8:	72 e2                	jb     801041ac <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
...
801041d4:	c9                   	leave  
  release(&ptable.lock);
801041d5:	e9 36 05 00 00       	jmp    80104710 <release>
...
801041ef:	e8 5c 04 00 00       	call   80104650 <acquire>
...
8010420a:	73 34                	jae    80104240 <kill+0x60>
    if(p->pid == pid){
...
8010422d:	e8 de 04 00 00       	call   80104710 <release>
      return 0;
80104232:	83 c4 10             	add    $0x10,%esp
80104235:	31 c0                	xor    %eax,%eax
    }
  }
  release(&ptable.lock);
  return -1;
}
80104237:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010423a:	c9                   	leave  
8010423b:	c3                   	ret    
...
80104248:	e8 c3 04 00 00       	call   80104710 <release>
  return -1;
...
8010427b:	68 18 78 10 80       	push   $0x80107818
80104280:	e8 db c3 ff ff       	call   80100660 <cprintf>
80104285:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104288:	81 c3 88 00 00 00    	add    $0x88,%ebx
8010428e:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80104294:	0f 83 86 00 00 00    	jae    80104320 <procdump+0xc0>
    if(p->state == UNUSED)
8010429a:	8b 43 0c             	mov    0xc(%ebx),%eax
8010429d:	85 c0                	test   %eax,%eax
8010429f:	74 e7                	je     80104288 <procdump+0x28>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801042a1:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801042a4:	ba f8 77 10 80       	mov    $0x801077f8,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801042a9:	77 11                	ja     801042bc <procdump+0x5c>
801042ab:	8b 14 85 6c 79 10 80 	mov    -0x7fef8694(,%eax,4),%edx
      state = "???";
801042b2:	b8 f8 77 10 80       	mov    $0x801077f8,%eax
801042b7:	85 d2                	test   %edx,%edx
801042b9:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
801042bc:	8d 43 6c             	lea    0x6c(%ebx),%eax
801042bf:	50                   	push   %eax
801042c0:	52                   	push   %edx
801042c1:	ff 73 10             	pushl  0x10(%ebx)
801042c4:	68 fc 77 10 80       	push   $0x801077fc
801042c9:	e8 92 c3 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
801042ce:	83 c4 10             	add    $0x10,%esp
801042d1:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
801042d5:	75 a1                	jne    80104278 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801042d7:	8d 45 c0             	lea    -0x40(%ebp),%eax
801042da:	83 ec 08             	sub    $0x8,%esp
801042dd:	8d 7d c0             	lea    -0x40(%ebp),%edi
801042e0:	50                   	push   %eax
801042e1:	8b 43 1c             	mov    0x1c(%ebx),%eax
801042e4:	8b 40 0c             	mov    0xc(%eax),%eax
801042e7:	83 c0 08             	add    $0x8,%eax
801042ea:	50                   	push   %eax
801042eb:	e8 40 02 00 00       	call   80104530 <getcallerpcs>
...
80104305:	83 c7 04             	add    $0x4,%edi
80104308:	52                   	push   %edx
80104309:	68 21 72 10 80       	push   $0x80107221
8010430e:	e8 4d c3 ff ff       	call   80100660 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80104313:	83 c4 10             	add    $0x10,%esp
80104316:	39 fe                	cmp    %edi,%esi
80104318:	75 de                	jne    801042f8 <procdump+0x98>
8010431a:	e9 59 ff ff ff       	jmp    80104278 <procdump+0x18>
8010431f:	90                   	nop
  }
}
...
//current process status showing RUNNING and SLEEPING
int
crsp()
{
...
8010433d:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  acquire(&ptable.lock);
80104342:	e8 09 03 00 00       	call   80104650 <acquire>
  cprintf("name \t pid \t state \n");
80104347:	c7 04 24 05 78 10 80 	movl   $0x80107805,(%esp)
8010434e:	e8 0d c3 ff ff       	call   80100660 <cprintf>
80104353:	83 c4 10             	add    $0x10,%esp
80104356:	eb 1b                	jmp    80104373 <crsp+0x43>
80104358:	90                   	nop
...
80104363:	74 5b                	je     801043c0 <crsp+0x90>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104365:	81 c3 88 00 00 00    	add    $0x88,%ebx
8010436b:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80104371:	73 2d                	jae    801043a0 <crsp+0x70>
      if ( p->state == SLEEPING )
80104373:	8b 43 0c             	mov    0xc(%ebx),%eax
80104376:	83 f8 02             	cmp    $0x2,%eax
80104379:	75 e5                	jne    80104360 <crsp+0x30>
        cprintf("%s \t %d  \t SLEEPING \n ", p->name, p->pid );
8010437b:	8d 43 6c             	lea    0x6c(%ebx),%eax
8010437e:	83 ec 04             	sub    $0x4,%esp
80104381:	ff 73 10             	pushl  0x10(%ebx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104384:	81 c3 88 00 00 00    	add    $0x88,%ebx
        cprintf("%s \t %d  \t SLEEPING \n ", p->name, p->pid );
8010438a:	50                   	push   %eax
8010438b:	68 1a 78 10 80       	push   $0x8010781a
80104390:	e8 cb c2 ff ff       	call   80100660 <cprintf>
80104395:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104398:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
8010439e:	72 d3                	jb     80104373 <crsp+0x43>
        cprintf("%s \t %d  \t RUNNING \n ", p->name, p->pid );
  }
...
801043a8:	e8 63 03 00 00       	call   80104710 <release>

  // returns its system call number
  return 22;
}
801043ad:	b8 16 00 00 00       	mov    $0x16,%eax
...
801043b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        cprintf("%s \t %d  \t RUNNING \n ", p->name, p->pid );
801043c0:	8d 43 6c             	lea    0x6c(%ebx),%eax
801043c3:	83 ec 04             	sub    $0x4,%esp
801043c6:	ff 73 10             	pushl  0x10(%ebx)
801043c9:	50                   	push   %eax
801043ca:	68 31 78 10 80       	push   $0x80107831
801043cf:	e8 8c c2 ff ff       	call   80100660 <cprintf>
801043d4:	83 c4 10             	add    $0x10,%esp
801043d7:	eb 8c                	jmp    80104365 <crsp+0x35>
...
801043ea:	68 84 79 10 80       	push   $0x80107984
...
80104445:	e8 76 fb ff ff       	call   80103fc0 <sleep>
  while (lk->locked) {
...
80104453:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104459:	e8 a2 f3 ff ff       	call   80103800 <myproc>
...
801044e3:	e8 18 f3 ff ff       	call   80103800 <myproc>
...
80104589:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010458a:	e8 d1 f1 ff ff       	call   80103760 <mycpu>
...
8010459f:	e8 bc f1 ff ff       	call   80103760 <mycpu>
801045a4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801045aa:	e8 b1 f1 ff ff       	call   80103760 <mycpu>
...
80104605:	68 8f 79 10 80       	push   $0x8010798f
8010460a:	e8 81 bd ff ff       	call   80100390 <panic>
    panic("popcli");
8010460f:	83 ec 0c             	sub    $0xc,%esp
80104612:	68 a6 79 10 80       	push   $0x801079a6
...
80104638:	e8 23 f1 ff ff       	call   80103760 <mycpu>
...
80104694:	e8 c7 f0 ff ff       	call   80103760 <mycpu>
...
801046f7:	68 ad 79 10 80       	push   $0x801079ad
...
8010474c:	68 b5 79 10 80       	push   $0x801079b5
...
801049f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801049fa:	e8 01 ee ff ff       	call   80103800 <myproc>
...
80104a65:	e8 96 ed ff ff       	call   80103800 <myproc>
...
80104a73:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a76:	e8 85 ed ff ff       	call   80103800 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104ab8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104abb:	e8 40 ed ff ff       	call   80103800 <myproc>
...
80104b54:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b57:	e8 a4 ec ff ff       	call   80103800 <myproc>
...
80104b6c:	8b 14 85 e0 79 10 80 	mov    -0x7fef8620(,%eax,4),%edx
...
80104b90:	68 bd 79 10 80       	push   $0x801079bd
...
80104ce4:	68 58 7a 10 80       	push   $0x80107a58
...
80104cfc:	68 57 7a 10 80       	push   $0x80107a57
...
80104d15:	68 4b 7a 10 80       	push   $0x80107a4b
...
80104d2a:	68 5a 7a 10 80       	push   $0x80107a5a
80104d2f:	e8 5c b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104d34:	83 ec 0c             	sub    $0xc,%esp
80104d37:	68 3c 7a 10 80       	push   $0x80107a3c
...
80104d74:	e8 87 ea ff ff       	call   80103800 <myproc>
...
80104db9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104dbb:	e8 40 ea ff ff       	call   80103800 <myproc>
...
80104f03:	78 2b                	js     80104f30 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104f05:	e8 f6 e8 ff ff       	call   80103800 <myproc>
...
80105129:	58                   	pop    %eax
8010512a:	5a                   	pop    %edx
8010512b:	68 58 7a 10 80       	push   $0x80107a58
...
80105144:	68 57 7a 10 80       	push   $0x80107a57
...
8010533f:	0f 84 a6 00 00 00    	je     801053eb <sys_open+0x12b>
  struct proc *curproc = myproc();
80105345:	e8 b6 e4 ff ff       	call   80103800 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105717:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010571a:	e8 e1 e0 ff ff       	call   80103800 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105751:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105758:	e8 a3 e0 ff ff       	call   80103800 <myproc>
...
80105793:	5d                   	pop    %ebp
  return fork();
80105794:	e9 07 e2 ff ff       	jmp    801039a0 <fork>
...
801057a3:	83 ec 08             	sub    $0x8,%esp
  exit();
801057a6:	e8 95 e6 ff ff       	call   80103e40 <exit>
...
801057b3:	5d                   	pop    %ebp
  return wait();
801057b4:	e9 c7 e8 ff ff       	jmp    80104080 <wait>
...
801057de:	e8 fd e9 ff ff       	call   801041e0 <kill>
...
80105803:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105806:	e8 f5 df ff ff       	call   80103800 <myproc>
...
80105827:	78 27                	js     80105850 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105829:	e8 d2 df ff ff       	call   80103800 <myproc>
  if(growproc(n) < 0)
...
80105836:	e8 e5 e0 ff ff       	call   80103920 <growproc>
...
80105880:	68 60 4f 11 80       	push   $0x80114f60
...
8010588d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105890:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  while(ticks - ticks0 < n){
...
801058a3:	68 60 4f 11 80       	push   $0x80114f60
801058a8:	68 a0 57 11 80       	push   $0x801157a0
801058ad:	e8 0e e7 ff ff       	call   80103fc0 <sleep>
  while(ticks - ticks0 < n){
801058b2:	a1 a0 57 11 80       	mov    0x801157a0,%eax
...
801058d0:	68 60 4f 11 80       	push   $0x80114f60
...
801058f3:	68 60 4f 11 80       	push   $0x80114f60
...
80105914:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105917:	68 60 4f 11 80       	push   $0x80114f60
8010591c:	e8 2f ed ff ff       	call   80104650 <acquire>
  xticks = ticks;
80105921:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  release(&tickslock);
80105927:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
...
80105943:	5d                   	pop    %ebp
  return crsp();
80105944:	e9 e7 e9 ff ff       	jmp    80104330 <crsp>
...
801059be:	00 00 ef 
  initlock(&tickslock, "time");
801059c1:	68 9d 7a 10 80       	push   $0x80107a9d
...
801059d4:	66 a3 a6 51 11 80    	mov    %ax,0x801151a6
  initlock(&tickslock, "time");
801059da:	e8 31 eb ff ff       	call   80104510 <initlock>
}
...
80105a40:	ff 24 85 44 7b 10 80 	jmp    *-0x7fef84bc(,%eax,4)
...
80105a50:	e8 ab dd ff ff       	call   80103800 <myproc>
...
80105a89:	e8 72 dd ff ff       	call   80103800 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105aa5:	68 00 7b 10 80       	push   $0x80107b00
80105aaa:	e8 b1 ab ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105aaf:	83 c4 20             	add    $0x20,%esp
80105ab2:	e8 49 dd ff ff       	call   80103800 <myproc>
...
80105abe:	e8 3d dd ff ff       	call   80103800 <myproc>
80105ac3:	85 c0                	test   %eax,%eax
80105ac5:	74 1d                	je     80105ae4 <trap+0xc4>
80105ac7:	e8 34 dd ff ff       	call   80103800 <myproc>
...
80105ae4:	e8 17 dd ff ff       	call   80103800 <myproc>
80105ae9:	85 c0                	test   %eax,%eax
80105aeb:	74 0b                	je     80105af8 <trap+0xd8>
80105aed:	e8 0e dd ff ff       	call   80103800 <myproc>
...
80105af6:	74 68                	je     80105b60 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105af8:	e8 03 dd ff ff       	call   80103800 <myproc>
...
80105b32:	0f 85 e8 00 00 00    	jne    80105c20 <trap+0x200>
    myproc()->tf = tf;
80105b38:	e8 c3 dc ff ff       	call   80103800 <myproc>
80105b3d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105b40:	e8 0b f0 ff ff       	call   80104b50 <syscall>
    if(myproc()->killed)
80105b45:	e8 b6 dc ff ff       	call   80103800 <myproc>
...
80105b7d:	e8 ce cb ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b82:	e8 79 dc ff ff       	call   80103800 <myproc>
...
80105b9d:	e8 ae cb ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ba2:	e8 59 dc ff ff       	call   80103800 <myproc>
...
80105bbd:	e8 8e cb ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bc2:	e8 39 dc ff ff       	call   80103800 <myproc>
...
80105bdf:	e8 fc db ff ff       	call   801037e0 <cpuid>
80105be4:	56                   	push   %esi
80105be5:	53                   	push   %ebx
80105be6:	50                   	push   %eax
80105be7:	68 a8 7a 10 80       	push   $0x80107aa8
...
80105bf6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bf9:	e8 02 dc ff ff       	call   80103800 <myproc>
...
80105c48:	e8 03 ea ff ff       	call   80104650 <acquire>
      wakeup(&ticks);
...
80105c85:	68 cc 7a 10 80       	push   $0x80107acc
80105c8a:	e8 d1 a9 ff ff       	call   80100660 <cprintf>
      panic("trap");
80105c8f:	83 c4 14             	add    $0x14,%esp
80105c92:	68 a2 7a 10 80       	push   $0x80107aa2
...
80105d8c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d8f:	bb c4 7b 10 80       	mov    $0x80107bc4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801068fa:	e8 61 de ff ff       	call   80104760 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010699d:	68 cc 7b 10 80       	push   $0x80107bcc
...
80106a53:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a56:	e8 85 cd ff ff       	call   801037e0 <cpuid>
...
80106b24:	0f 84 c2 00 00 00    	je     80106bec <switchuvm+0xec>
  pushcli();
80106b2a:	e8 51 da ff ff       	call   80104580 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106b2f:	e8 2c cc ff ff       	call   80103760 <mycpu>
80106b34:	89 c6                	mov    %eax,%esi
80106b36:	e8 25 cc ff ff       	call   80103760 <mycpu>
80106b3b:	89 c7                	mov    %eax,%edi
80106b3d:	e8 1e cc ff ff       	call   80103760 <mycpu>
80106b42:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106b45:	83 c7 08             	add    $0x8,%edi
80106b48:	e8 13 cc ff ff       	call   80103760 <mycpu>
...
80106c70:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c71:	e9 9a db ff ff       	jmp    80104810 <memmove>
    panic("inituvm: more than a page");
80106c76:	83 ec 0c             	sub    $0xc,%esp
80106c79:	68 11 7c 10 80       	push   $0x80107c11
...
80106d9b:	e8 c0 d9 ff ff       	call   80104760 <memset>
...
80106ddd:	68 49 7c 10 80       	push   $0x80107c49
...
80106e13:	68 61 7c 10 80       	push   $0x80107c61
...
80106f1c:	68 7d 7c 10 80       	push   $0x80107c7d
...
80106f50:	e8 0b d8 ff ff       	call   80104760 <memset>
...
80106fef:	68 8e 7c 10 80       	push   $0x80107c8e
...
80107040:	e8 cb d7 ff ff       	call   80104810 <memmove>
...
801070d9:	68 b2 7c 10 80       	push   $0x80107cb2
801070de:	e8 ad 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
801070e3:	83 ec 0c             	sub    $0xc,%esp
801070e6:	68 98 7c 10 80       	push   $0x80107c98
...
8010716f:	e8 9c d6 ff ff       	call   80104810 <memmove>
    len -= n;
    buf += n;
